...
//@author Théo Cerdan
//@title The Tropical Brothers ERC721A Contract
...
contract TTBERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRoot, string memory _baseURI) ERC721A("The Tropical Brothers", "TTB")
